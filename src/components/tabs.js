                  ...
                  <div className="row">
                    <div className="col-md-6 col-xs-12">
                      ...
                      <div className="details">
                        <img src={service1_1} />
                        <p>
                        <span className="serviceplan">Qimia Enterprise Data Hub</span>
                          Off-the-shelf Big Data Platform:
                          <br />
                          off-the-shelf Hadoop cluster and cloud data lake
                          deployment. Hadoop Data Hub: Apache Hadoop, Apache
                          Spark, Apache Hive, HBase, Zeppelin. Cloud Data Lake:
                    ...
                    <div className="col-md-6 col-xs-12">
                      ...
                      <div className="details">
                        <img src={service1_2} />
                        <p>
                          <span className="serviceplan">Big Data Consulting Services</span>
                    ...
                    <div className="col-md-6 col-xs-12">
                      ...
                      <div className="details">
                        <img src={service1_3} />
                        <p>
                        <span className="serviceplan">Qimia Data Hub Operational Service</span>
                    ...
                    <div className="col-md-6 col-xs-12">
                      ...
                      <div className="details">
                        <img src={service1_4} />
                        <p>
                          <span className="serviceplan">Standard Data Solutions</span>
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6 col-xs-12">
                      ...
                      <div className="details">
                        <img src={service2_3} />
                        <p>
                        <span className="serviceplan">Cloud Migration and Cost Management</span>
                  ...
                  <div className="row">
                    <div className="col-md-6 col-xs-12">
                      ...
                      <div className="details">
                        <img src={service3_1} />
                        <p>
                          <span className="serviceplan">Data Analytics Components</span>
                    ...
                    <div className="col-md-6 col-xs-12">
                      ...
                      <div className="details">
                        <img src={service3_2} />
                        <p>
                        <span className="serviceplan">Data Visualization</span>
                          Tableau, Qlik, PowerBI and Superset.</p>
                      </div>
                    </div>
                    <div className="col-md-6 col-xs-12">
                      ...
                      <div className="details">
                        <img src={service3_3} />
                        <p>
                        <span className="serviceplan">Standard Model Implementation</span>
                    ...
                    <div className="col-md-6 col-xs-12">
                      ...
                      <div className="details">
                        <img src={service2_4} />
                        <p>
                        <span className="serviceplan">Secure Notebook Deployment</span>
